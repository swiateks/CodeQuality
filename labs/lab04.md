...
3. Edit the file and copy the following code after line 5.
    ...
    ```
4. Open the interface [FeatheredCreature.java](../module4/SOLID-main/interface_segregation/good/src/FeatheredCreature.java)
5. Edit the file and copy the following code after line 5.
    ```
     public void molt();
    ```
6. Open the interface [FlyingCreature.java](../module4/SOLID-main/interface_segregation/good/src/FlyingCreature.java)
7. Edit the file and copy the following code after line 5.
    ```
     public void fly();
    ```
8. Open the interface [SwimmingCreature.java](../module4/SOLID-main/interface_segregation/good/src/SwimmingCreature.java)
9. Edit the file and copy the following code after line 5.
    ```
    public void swim();
    ```
10. Open the java file [PenguinModified.java](../module4/SOLID-main/interface_segregation/good/src/PenguinModified.java)
11. Edit the file and copy the following code after line 5.
    ...
    ```
12. You have now implemented interface segregation.
